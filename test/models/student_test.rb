...
class StudentTest < ActiveSupport::TestCase
  ...
  def test_topics
    ...
    crowd_topics = []
    crowd_topics_num = 3.times { Delorean.jump 30; crowd_topics << Fabricate(:topic, circle: crowd, creator: crowd.professor) }
    unapproved_topics = []
    unapproved_topics_count = 2.times { Delorean.jump 30; unapproved_topics << Fabricate(:topic, circle: crowd, creator: student) }
